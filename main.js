...
document.addEventListener('DOMContentLoaded', function() {
  ...
  const translations = {
    en: {
      ...
      'history.bootcamp.year': '2025 - Present',
      ...
      'history.transition.period': '2023 - 2025',
      ...
      'history.bootcampjourney.period': '2025 - Present',
    ...
    id: {
      ...
      'history.bootcamp.program': 'Senin Fullstack Developer',
      'history.bootcamp.year': '2025 - Sekarang',
      ...
      'history.bootcampjourney.period': '2025 - Sekarang',
